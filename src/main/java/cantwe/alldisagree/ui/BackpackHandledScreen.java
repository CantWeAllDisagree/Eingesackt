package cantwe.alldisagree.ui;

import cantwe.alldisagree.Bagged;
import cantwe.alldisagree.api.Dimension;
import cantwe.alldisagree.api.Rectangle;
...
public class BackpackHandledScreen extends HandledScreen<BackpackScreenHandler> {
    ...
    private static final Identifier GUI_TEXTURE = new Identifier("bagged", "textures/gui/backpack_container.png");
    private static final Identifier SLOT_TEXTURE = new Identifier("bagged", "textures/gui/backpack_slot.png");
   ...
   // private final static int INVENTORY_LABEL_EXTRA = 8;
    private final int guiTitleColor = Integer.decode(Bagged.CONFIG.guiTitleColor);
