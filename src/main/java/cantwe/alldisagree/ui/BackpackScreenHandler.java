...
import cantwe.alldisagree.util.InventoryUtils;
import cantwe.alldisagree.api.Point;
...
public class BackpackScreenHandler extends ScreenHandler {
    ...
    public BackpackScreenHandler(int synchronizationID, PlayerInventory playerInventory, ItemStack backpackStack) {
        super(Bagged.CONTAINER_TYPE, synchronizationID);
    ...
    private class BackpackLockedSlot extends Slot {
        ...
        public boolean canInsert(ItemStack stack) {
            ...
            if(Bagged.CONFIG.unstackablesOnly) {
            ...
            if(Bagged.CONFIG.disableShulkers && inventory instanceof BackpackInventory) {
