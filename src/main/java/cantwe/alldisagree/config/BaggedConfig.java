...
public class BaggedConfig implements Config {
    ...
    @Comment(value = "Whether Shulker Boxes should be blacklisted from being placed inside Säckar Backpacks.")
    ...
    @Comment(value = "Color of the text rendered in the Bagged GUI.")
